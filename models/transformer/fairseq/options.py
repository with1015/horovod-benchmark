...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--distributed-world-size', default=-1, type=int,
                        help='number of nodes for distributed training')
    group.add_argument('--distributed-rank', default=-1, type=int,
                        help='node rank for distributed training')
    group.add_argument('--dist-url', default='tcp://127.0.0.1:8000', type=str,
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--restore-file', default=None,
